...
/*   EGTS_SR_SERVICE_FULL_DATA , service FIRMWARE, implementation            */
/*                                                                           */
...
/*****************************************************************************/
/*                                                                           */
/* egts_get_size_FIRMWARE_FULL_DATA()                                        */
/*                                                                           */
/* Description: Returns size of specified FIRMWARE_FULL_DATA subrecord       */
/*                                                                           */
...
static
u16   egts_get_size_FIRMWARE_FULL_DATA( void* pv_subrecord );


/*****************************************************************************/
/*                                                                           */
/* egts_read_FIRMWARE_FULL_DATA()                                            */
/*                                                                           */
/* Description: Read subrecord FIRMWARE_FULL_DATA from buffer                */
/*                                                                           */
/* Arguments: pv_subrecord - pointer to subrecord                            */
...
static
int   egts_read_FIRMWARE_FULL_DATA( void* pv_subrecord , u16 SRL , 
  u8**  ppbuf ,
  u16*  pbuf_sz );

/*****************************************************************************/
/*                                                                           */
/* egts_write_FIRMWARE_FULL_DATA()                                           */
/*                                                                           */
/* Description: Write subrecord FIRMWARE_FULL_DATA to buffer                 */
/*                                                                           */
/* Arguments: pv_subrecord - pointer to subrecord                            */
/*            ppbuf - pointer to buffer begin                                */
/*            pbuf_sz - size of buffer                                       */
...
static
int   egts_write_FIRMWARE_FULL_DATA( void* pv_subrecord ,
  u8**   ppbuf ,
  u16*   pbuf_sz );
...
/*****************************************************************************/
/*                                                                           */
/* egts_is_equial_FIRMWARE_FULL_DATA()                                       */
/*                                                                           */
/* Description: Member-wise compare FIRMWARE_FULL_DATA subrecords            */
/*                                                                           */
...
static
int  egts_is_equial_FIRMWARE_FULL_DATA( void* ctx , void* pv_subrecord1 , void* pv_subrecord2 );

/*****************************************************************************/
/*                                                                           */
/* egts_dump_FIRMWARE_FULL_DATA()                                            */
/*                                                                           */
/* Description: Dump content of FIRMWARE_FULL_DATA subrecord                 */
/*                                                                           */
/* Arguments: ctx - dump callback context                                    */
...
static
void  egts_dump_FIRMWARE_FULL_DATA( void* ctx , void* pv_subrecord ,
...
u16   egts_get_size_FIRMWARE_FULL_DATA( void* pv_subrecord )
{
  egts_FIRMWARE_FULL_DATA_t* psrec = (egts_FIRMWARE_FULL_DATA_t*)pv_subrecord;
  u16 s = 0U;
...
int  egts_is_equial_FIRMWARE_FULL_DATA( void* ctx , void* pv_subrecord1 , void* pv_subrecord2 )
{
  egts_FIRMWARE_FULL_DATA_t* psrec1 = (egts_FIRMWARE_FULL_DATA_t*)pv_subrecord1;
  egts_FIRMWARE_FULL_DATA_t* psrec2 = (egts_FIRMWARE_FULL_DATA_t*)pv_subrecord2;
  ...
  )
{
  ...
  (*afn_dump)( ctx , "SR_FULL_DATA_header:\n");
...
const egts_subrecord_handler_t  chandler_FIRMWARE_FULL_DATA = 
{
  /* SRT */             (u8)EGTS_SR_SERVICE_FULL_DATA ,
  /* subrecord_size */  (u16)sizeof(egts_FIRMWARE_FULL_DATA_t) ,
  /* fn_get_size */     egts_get_size_FIRMWARE_FULL_DATA ,
  /* fn_read */         egts_read_FIRMWARE_FULL_DATA ,
  /* fn_write */        egts_write_FIRMWARE_FULL_DATA ,
#ifdef EGTS_DBG
  /* fs_is_equial */    egts_is_equial_FIRMWARE_FULL_DATA ,
  /* fn_dump */         egts_dump_FIRMWARE_FULL_DATA 
#endif
};
